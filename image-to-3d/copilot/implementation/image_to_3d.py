"""Image-to-3D skill implementation for Copilot CLI runtime.

Provides the same API as the Claude implementation, designed for use
within GitHub Copilot CLI agent context.

Usage:
    import sys
    sys.path.insert(0, '/opt/skills/image-to-3d/copilot/implementation')
...
logger = logging.getLogger("image-to-3d.copilot")


class ImageTo3D:
    """Copilot CLI interface for image-to-3D conversion."""
